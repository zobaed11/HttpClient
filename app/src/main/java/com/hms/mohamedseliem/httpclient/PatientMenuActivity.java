...
import com.hms.mohamedseliem.httpclient.fragment.AppointmentFragment;
import com.hms.mohamedseliem.httpclient.fragment.NotificationsFragment;
...
import com.hms.mohamedseliem.httpclient.entities.CircleTransform;
import android.content.Intent;
import android.support.v7.app.AppCompatActivity;
import android.os.Bundle;
import android.view.View;
...
public class PatientMenuActivity extends AppCompatActivity implements HomeFragment.OnFragmentInteractionListener,
...
// let it stay blank. No need for any code here.
    ...
    private void loadNavHeader() {
        // name, website
        txtName.setText("SM Zobaed");
        txtWebsite.setText("https://hms.app");
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_about_us:
                        ...
                        startActivity(new Intent(PatientMenuActivity.this, AboutUS.class));
                        drawer.closeDrawers();
                        return true;
                    case R.id.nav_privacy_policy:
                        // launch new intent instead of loading fragment
                        startActivity(new Intent(PatientMenuActivity.this, PrivacyPolicy.class));
                        drawer.closeDrawers();
                        return true;
                    case R.id.logout:
                        TokenManager tokenManager = TokenManager.getInstance(getSharedPreferences("prefs", MODE_PRIVATE));
                            ...
                            startActivity(new Intent(PatientMenuActivity.this, LoginActivity.class));
                            return true;
