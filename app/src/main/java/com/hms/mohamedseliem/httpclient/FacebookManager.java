...
public class FacebookManager {
    ...
    private Call<com.hms.mohamedseliem.httpclient.entities.AccessToken> call;
    ...
    private void getTokenFromBackend(String name, String email, String provider, String providerUserId){
        ...
        call.enqueue(new Callback<com.hms.mohamedseliem.httpclient.entities.AccessToken>() {
            @Override
            public void onResponse(Call<com.hms.mohamedseliem.httpclient.entities.AccessToken> call, Response<com.hms.mohamedseliem.httpclient.entities.AccessToken> response) {
            ...
            @Override
            public void onFailure(Call<com.hms.mohamedseliem.httpclient.entities.AccessToken> call, Throwable t) {
